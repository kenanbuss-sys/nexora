...
export const BS: Record<string, string> = {
  ...
  Objects: 'Objekti',
  'Custom objects': 'Prilagođeni objekti',
  'Form builder': 'Kreator formi',
  'Define object': 'Definiši objekat',
  'Add field': 'Dodaj polje',
  'Save record': 'Sačuvaj zapis',
  Records: 'Zapisi',
  'No records yet.': 'Još nema zapisa.',
  'No custom objects yet.': 'Još nema prilagođenih objekata.',
  'Object defined.': 'Objekat definisan.',
  'Record saved.': 'Zapis sačuvan.',
  'Select an object to open its form.': 'Odaberite objekat da otvorite formu.',
  Fulfillment: 'Isporuka',
  Delivery: 'Dostava',
  'Pickup (click & collect)': 'Preuzimanje (click & collect)',
  'Project reference (optional)': 'Referenca projekta (opcionalno)',
  'Ready for pickup': 'Spremno za preuzimanje',
  'Order marked ready for pickup.': 'Narudžba označena kao spremna za preuzimanje.',
  shipped: 'otpremljeno',
  Packages: 'Paketi',
  Pack: 'Spakuj',
  Stage: 'Pripremi za otpremu',
  Ship: 'Otpremi',
  'Package created.': 'Paket kreiran.',
  'Package staged.': 'Paket pripremljen za otpremu.',
  'Package shipped.': 'Paket otpremljen.',
  'Bins & putaway': 'Police i uskladištenje',
  'Nothing put away yet.': 'Još ništa nije uskladišteno.',
  'Add bin': 'Dodaj policu',
  'Put away': 'Uskladišti',
  'Stock put away.': 'Roba uskladištena.',
  ...
  'What went wrong?': 'Šta nije u redu?',
  'Claim filed — our service team will follow up.':
    'Reklamacija zaprimljena — servisni tim će se javiti.',
  'Work-center load': 'Opterećenje radnih centara',
  'Place order': 'Naruči',
  'Order placed — thank you.': 'Narudžba zaprimljena — hvala.',
  'Nudge abandoned drafts': 'Podsjeti na napuštene narudžbe',
  'Allocate backorders': 'Rasporedi zaostale narudžbe',
  'Cost suggestions': 'Prijedlozi cijena iz troška',
  'No SKUs with a standard cost yet.': 'Još nema artikala sa standardnim troškom.',
  '3-way match': 'Trostruko sravnjenje',
  'Unknown unit of measure': 'Nepoznata jedinica mjere',
  Backflush: 'Backflush (trošenje pri završetku)',
  ...
  'in progress:': 'u radu:',
  'avg resolve:': 'prosj. rješavanje:',
  'SLA overdue:': 'SLA probijeno:',
  'open:': 'otvoreno:',
  Quarantine: 'Karantin',
  'Load holds': 'Učitaj zadrške',
  'Held quantities cannot be reserved until quality releases or scraps them.':
    'Zadržane količine se ne mogu rezervisati dok ih kvalitet ne oslobodi ili otpiše.',
  'Hold released.': 'Zadrška oslobođena.',
  'Hold scrapped — stock adjusted.': 'Zadrška otpisana — zaliha korigovana.',
  'Quarantine hold placed.': 'Karantinska zadrška postavljena.',
  'Place hold': 'Postavi zadršku',
  Reason: 'Razlog',
  'Production by day': 'Proizvodnja po danima',
  'My catalog': 'Moj katalog',
  'What your agreement entitles you to buy, at your prices.':
    'Ono što po ugovoru možeš kupiti, po tvojim cijenama.',
  'No catalog yet.': 'Još nema kataloga.',
